...
import { LayoutDashboard, Music, StickyNote } from 'lucide-react';
...
export const DEFAULT_FEATURES: OptionalFeatures = { sessionBoard: true, dmNotes: true, ambientMusic: true };
...
export function FeaturesSettings({ features, onChange }: FeaturesSettingsProps) {
  return <section aria-labelledby="features-heading" className="rounded-2xl border border-outline-variant/20 bg-surface-container-low p-4 sm:p-5">
    ...
    <p className="mt-1 text-xs text-outline">Choose which floating panels appear in this browser. Saved notes and session data are kept.</p>
